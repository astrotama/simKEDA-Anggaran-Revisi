<?php
function kegiatanskpd_printusulan_main() {
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		if (isset($sampul))  {
			...
			if ($sampul=='sp') {
				...
				$pdfFile = 'penolakan-revisi-' . $id . '.pdf';
				$htmlContent = PrintPenolakan($id);
				apbd_ExportPDF3P_Surat($topmargin,$topmargin, '', $htmlContent, '', $pdfFile, $hal1, true, 'P');
				//return $htmlContent;
			...
			if ($tipedok=='rka') {
				...
				$htmlContent = GenReportFormContentRKA($kodekeg);
			...
			//$output = drupal_get_form('kegiatanskpd_printusulan_form');
			//$output .= $htmlContent;
			//return $output;
...
function GenReportFormHeader($kodekeg, $tipedok) {
	...
	$pquery = sprintf('select k.kodekeg, k.lokasi, k.programsasaran, k.programtarget, k.masukansasaran, k.masukantarget, k.keluaransasaran, k.keluarantarget, 
				...
				k.sumberdana1, k.sumberdana2, k.sumberdana1rp, k.sumberdana2rp, k.latarbelakang, k.kelompoksasaran, k.anggaran, k.bintang  
	...
	if ($data = db_fetch_object($pres)) {
		...
		$kegiatan = $data->kodedinas . '.' . $data->kodepro . '.' . $data->nomorkeg . ' - ' .  $data->kegiatan . $statuskegiatan;
			...
			if ($resultobyek) {
				while ($dataobyek = db_fetch_object($resultobyek)) {
					...
					$rowsrek[] = array (
										 ...
										 array('data' => apbd_fn($dataobyek->jumlahx-$penobyek),  'width' => '70px', 'style' => 'border-right: 1px solid black; border-bottom: 1px solid black;text-align:right;font-size:small;font-weight:bold;'),
					...
					if ($result) {
						...
						$sql = 'select kodero,uraian,jumlah,anggaran,bintang from {anggperkeg} where kodekeg=\'%s\' and kodero=\'%s\'';
						$fsql = sprintf($sql, db_escape_string($kodekeg), db_escape_string($data->kodero));
...
//								
						...
						$rowsrek[] = array (
											 ...
											 array('data' => apbd_fn($data->jumlah - $penrekening),  'width' => '70px', 'style' => ' border-right: 1px solid black; text-align:right;font-size:small;font-weight:bold;'),
							...
							//DETIL
							$sql = 'select distinct iddetil,uraian,unitjumlah,unitsatuan,volumjumlah,volumsatuan,harga,total, pengelompokan from {anggperkegdetilrevisi} where kodekeg=\'%s\' and kodero=\'%s\' order by nourut asc,iddetil';
							$fsql = sprintf($sql, db_escape_string($kodekeg), db_escape_string($data->kodero));
							////////drupal_set_message($fsql);
							...
							if ($resultdetil) {
								while ($datadetil = db_fetch_object($resultdetil)) {
									$statusdetil = '';
									if ($penrekening > 0) {
										$sql = 'select iddetil,uraian,unitjumlah,unitsatuan,volumjumlah,volumsatuan,harga,total, pengelompokan,anggaran,bintang from {anggperkegdetil} where kodekeg=\'%s\' and kodero=\'%s\' and iddetil=\'%s\'';
									...
									if ($datadetil->uraian == $datadetilpenuraian) {
										...
										if ($datadetil->pengelompokan) {
											//SUB DETIL
											$sql = 'select idsub,uraian,unitjumlah,unitsatuan,volumjumlah,volumsatuan, harga,total,anggaran,bintang from {anggperkegdetilsubrevisi} where iddetil=\'%s\' order by nourut asc,idsub';
											$fsql = sprintf($sql, db_escape_string($datadetil->iddetil));
											////////drupal_set_message($fsql);
											...
											if ($resultsub) {
												while ($datasub = db_fetch_object($resultsub)) {
													...
													if (($penrekening > 0) and ($datadetil->uraian == $datadetilpenuraian)) {
														...
														$sql = 'select idsub,uraian,unitjumlah,unitsatuan,volumjumlah,volumsatuan, harga,total,anggaran,bintang from {anggperkegdetilsub} where iddetil=\'%s\' and idsub=\'%s\'';
														...
														if ($resultsubpen) {
															if ($datasubpen = db_fetch_object($resultsubpen)) {
																...
																if ($statusdetil=='')
																	if ($datasubpen->bintang==0)
																		$statusdetilsub = '';
																	else
																		$statusdetilsub = '<font color="Red">*</font>';
																
																else
																	$statusdetilsub = $statusdetil;
															...
															if (trim($datasuburaian_pen) == trim($datasub->uraian)) {
																...
																if (($datasuburaian_pen !='') and ($datasubtotal_pen>0)) {
																	...
																	$rowsrek[] = array (
																			 array('data' => '',  'width'=> '60px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:small;'),
																			 array('data' => '',  'width' => '15px', 'style' => 'text-align:right;font-size:small;'),
																			 array('data' =>  '- ' . $datasuburaian_pen . $statusdetilsub,  'width' => '215px', 'style' => ' border-right: 1px solid black; text-align:left;font-size:small;font-weight:lighter;font-style: italic;'),
																			 array('data' => $datasubunitjumlah_pen, 'width' => '60px', 'style' => ' border-right: 1px solid black; text-align:center;font-size:small;font-weight:lighter;font-style: italic;'),
																			 array('data' => $datasubvolumjumlah_pen, 'width' => '60px', 'style' => ' border-right: 1px solid black; text-align:center;font-size:small;font-weight:lighter;font-style: italic;'),
																			 array('data' => apbd_fn($datasubharga_pen),  'width' => '60px', 'style' => ' border-right: 1px solid black; text-align:right;font-size:small;font-weight:lighter;font-style: italic;'),
																			 array('data' => apbd_fn($datasubtotal_pen),  'width' => '60px', 'style' => ' border-right: 1px solid black; text-align:right;font-size:small;font-weight:lighter;font-style: italic;'),
																...
																//if ($datasub->total!=$datasub->anggaran) $statusdetilsub = '<font color="Red">*</font>';
										...
										if (($datadetilpenuraian) !='' and ($datadetilpentotal>0)) {
											...
											if ($datadetil->pengelompokan) {
												...
												//SUB DETIL
												$sql = 'select idsub,uraian,unitjumlah,unitsatuan,volumjumlah,volumsatuan, harga,total,anggaran,bintang from {anggperkegdetilsub} where iddetil=\'%s\' order by nourut asc,idsub';
												$fsql = sprintf($sql, db_escape_string($datadetil->iddetil));
												////////drupal_set_message($fsql);
	...
	//$output .= createT($headersrek, $rowsrek);
	return $output;
	
}

function GenReportFormContentRKA($kodekeg) {
	...
	$headersrek[] = array (
						 array('data' => 'K ODE',  'width'=> '60px', 'rowspan'=>'2','style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;font-size:small;'),
		...
		while ($datajenis = db_fetch_object($resultjenis)) {
			...
			if ($resultobyek) {
				while ($dataobyek = db_fetch_object($resultobyek)) {
					...
					//REKENING
					$sql = 'select kodero,uraian,jumlah,anggaran,bintang from {anggperkegrevisi} k where kodekeg=\'%s\' and mid(k.kodero,1,5)=\'%s\'';
					$fsql = sprintf($sql, db_escape_string($kodekeg), db_escape_string($dataobyek->kodeo));
					...
					if ($result) {
						...
						$rowsrek[] = array (
							...
							$sql = 'select distinct iddetil,uraian,unitjumlah,unitsatuan,volumjumlah,volumsatuan,harga,total, pengelompokan, anggaran,bintang from {anggperkegdetilrevisi} where kodekeg=\'%s\' and kodero=\'%s\' order by nourut asc,iddetil';
							$fsql = sprintf($sql, db_escape_string($kodekeg), db_escape_string($data->kodero));
							////////drupal_set_message($fsql);
							...
							if ($resultdetil) {
								while ($datadetil = db_fetch_object($resultdetil)) {
									...
									if ($penrekening > 0) {
										...
										$bintangdetilpenetapan = 0;
										$resultdetilpen = db_query($fsql);
										if ($datadetilpen = db_fetch_object($resultdetilpen)) {
											$datadetilpenuraian = $datadetilpen->uraian;
											$datadetilpentotal = $datadetilpen->total;
											$datadetilpenanggaran = $datadetilpen->anggaran;
											$bintangdetilpenetapan = $datadetilpen->bintang;
										}
										
										//bintang penetapan
										if ($bintangdetilpenetapan==1) {
									...
									if ($datadetil->uraian == $datadetilpenuraian) {
										...
										if (($datadetil->uraian) !='' and ($datadetil->total>0)) {
											...
											if ($datadetil->pengelompokan) {
												...
												//SUB DETIL
												$sql = 'select idsub,uraian,unitjumlah,unitsatuan,volumjumlah,volumsatuan, harga,total,anggaran,bintang from {anggperkegdetilsubrevisi} where (harga*unitjumlah*volumjumlah)>0 and iddetil=\'%s\' order by nourut asc,idsub';
												$fsql = sprintf($sql, db_escape_string($datadetil->iddetil));
										...
										} else if (($datadetil->uraian) !='' and ($datadetil->total<0)) {
											$rowsrek[] = array (
																 array('data' => '',  'width'=> '60px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:small;'),
																 array('data' => $bullet,  'width' => '15px', 'style' => 'text-align:right;font-size:small;'),
																 array('data' => $datadetil->uraian . $statusdetilsub,  'width' => '215px', 'style' => ' border-right: 1px solid black; text-align:left;font-size:small;font-weight:lighter;'),
...
function GenReportFormContentDPA($kodekeg) {
	...
	$bintangkegiatan = false;
	$sql = 'select anggaran from {kegiatanperubahan} where kodekeg=\'%s\'';
	$fsql = sprintf($sql, db_escape_string($kodekeg));
	$res = db_query($fsql);
	if ($res) {
		if ($data = db_fetch_object($res)) {
		...
		while ($datajenis = db_fetch_object($resultjenis)) {
			...
			if ($resultobyek) {
				while ($dataobyek = db_fetch_object($resultobyek)) {
					...
					//REKENING
					$sql = 'select kodero,uraian,jumlah,anggaran,bintang from {anggperkegperubahan} k where kodekeg=\'%s\' and mid(k.kodero,1,5)=\'%s\'';
					$fsql = sprintf($sql, db_escape_string($kodekeg), db_escape_string($dataobyek->kodeo));
					...
					if ($result) {
						...
						$rowsrek[] = array (
							...
							//DETIL
							$sql = 'select distinct iddetil,uraian,unitjumlah,unitsatuan,volumjumlah,volumsatuan,harga,total, pengelompokan,anggaran,bintang from {anggperkegdetilperubahan} where kodekeg=\'%s\' and kodero=\'%s\' order by nourut asc,iddetil';
							$fsql = sprintf($sql, db_escape_string($kodekeg), db_escape_string($data->kodero));
							////////drupal_set_message($fsql);
							...
							if ($resultdetil) {
								while ($datadetil = db_fetch_object($resultdetil)) {
									...
									if ($datadetil->uraian == $datadetilpenuraian) {
										...
										if ($datadetil->pengelompokan) {
											//SUB DETIL
											$sql = 'select idsub,uraian,unitjumlah,unitsatuan,volumjumlah,volumsatuan, harga,total,anggaran from {anggperkegdetilsubperubahan} where iddetil=\'%s\' order by nourut asc,idsub';
											$fsql = sprintf($sql, db_escape_string($datadetil->iddetil));
											////////drupal_set_message($fsql);
...
function PrintSuratPermohonanPerubahan($id) {
	...
	$sql = sprintf('select k.jenis,k.nomorkeg, k.kodepro, k.kegiatan, 
				uk.kodedinas from {kegiatanrevisi} k left join {unitkerja} uk 
				on k.kodeuk=uk.kodeuk where k.kodekeg=\'%s\'' . $where, db_escape_string($kodekeg));
	$res = db_query($sql);
	if ($data = db_fetch_object($res)) {
	...
	if ($jenis=='2') {
		...
		$sql = sprintf('select btlno dpano,btltgl dpatgl from {dpanomor} where kodeuk=\'%s\'' , db_escape_string($kodeuk));
		$res = db_query($sql);
		if ($data = db_fetch_object($res)) {
			$dpano = $data->dpano;
			$dpatgl = $data->dpatgl;
	...
	if ($jenis=='2') {
		...
		$sql = sprintf('select dpabtlformat dpaformat from {setupapp} where tahun=\'%s\'', db_escape_string($tahun));	
		$res = db_query($sql);
		if ($res) {
			if ($data = db_fetch_object($res)) {
				$dpaformat = $data->dpaformat;
...
function kegiatanskpd_printusulan_form () {
	$form['formdata'] = array (
		'#type' => 'fieldset',
...
function kegiatanskpd_printusulan_form_submit($form, &$form_state) {
	//$kodeuk = $form_state['values']['kodeuk'];
	$tipedok = $form_state['values']['tipedok'];		
	$id = $form_state['values']['id'];
	$aprove = $form_state['values']['statusapv'];
	...
	if ($tipedok=='rpka') {
		$uri = 'apbd/kegiatanskpd/printusulan/' . $id  . '/'. $topmargin . '/' . $tipedok . '/pdf';
		...
		$uri_surat = 'apbd/kegiatanskpd/printusulan/' . $id_x . '/'. $topmargin . '/' . $tipedok . '/pdf';
...
function PrintPersetujuan($id) {
	...
	$sql = 'select kp.id,kp.jenisrevisi,kp.kodekeg,kp.kodeuk, kp.kodekeg, 
			kp.subjenisrevisi, kp.kodeuk, kp.kodekeg, kp.geserblokir, kp.geserrincian, kp.geserobyek, kp.lokasi, kp.sumberdana, kp.kinerja, kp.sasaran, kp.detiluraian, kp.rab, kp.triwulan, kp.lainnya, kp.nosurat, kp.tglsurat, kp.persetujuanno, kp.persetujuantgl, kr.kegiatan, uk.namauk, uk.namasingkat, uk.pimpinanjabatan		
	...
	if ($data = db_fetch_object($res)) {
		...
		$kodeuk = $data->kodeuk; 
		$namauk = $data->namauk;
		$pimpinanjabatanskpd = $data->pimpinanjabatan;
	...
	switch($jenisrevisi) {
		case '1':		//GESER
			...
			if ($kodeukttd=='81') {
				$rows[] = array (
							array('data' => '',  'width'=> '235px', 'colspan'=>'4','style' => 'text-align:left;'),
							array('data' => 'KEPALA BPKAD KABUPATEN JEPARA',  'width'=> '300px', 'style' => ' text-align:center;'),
							);
				$rows[] = array (
							array('data' => '',  'width'=> '235px', 'colspan'=>'4','style' => 'text-align:left;'),
...
function PrintPenolakan($id) {
	 
	$sql = 'select kp.id,kp.jenisrevisi,kp.kodekeg,kp.kodeuk, kp.kodekeg, 
			kp.subjenisrevisi, kp.kodeuk, kp.kodekeg, kp.geserblokir, kp.geserrincian, kp.geserobyek, kp.lokasi, kp.sumberdana, kp.kinerja, kp.sasaran, kp.detiluraian, kp.rab, kp.triwulan, kp.lainnya, kp.nosurat, kp.tglsurat, kp.persetujuanno, kp.persetujuantgl, kr.kegiatan, uk.namauk, uk.namasingkat, uk.pimpinanjabatan,kp.jawaban		
			from {kegiatanrevisiperubahan} kp inner join {kegiatanrevisi} kr 
			on kp.kodekeg=kr.kodekeg inner join {unitkerja} uk on kp.kodeuk=uk.kodeuk where kp.id=\'%s\'';
	$res = db_query(db_rewrite_sql($sql), array ($id));
	if ($data = db_fetch_object($res)) {
	...
	*/
	...
	$rows[] = array (
				array('data' => 'Perihal',  'width'=> '50px', 'style' => 'text-align:left;'),
				array('data' => ':',  'width'=> '15px', 'style' => 'text-align:left;'),
				array('data' => 'Penolakan Revisi Anggaran', 'colspan'=>'3', 'width' => '460px', 'style' => 'text-align:left;'),
				);
	...
	switch($jenisrevisi) {
		case '1':		//GESER
			...
			$isian = 'Permohonan Saudara untuk melaksanakan perubahan atau pergeseran dalam hal pagu anggaran tetap untuk jenis ' . $ralat . ' kegiatan ' . $kegiatan . '  kami tolak karena tidak sesuai dengan Pasal 3 Peraturan Bupati Jepara Nomor 6 Tahun 2014 Tentang Tata Cara Revisi Anggaran ('.$jawaban.')';
			$rows[] = array (
						array('data' => '1.',  'width'=> '20px', 'style' => 'text-align:left;'),
						array('data' => $isian, 'colspan'=>'3', 'width' => '515px', 'style' => 'text-align:left;'),
						);
			$rows[] = array (
						...
						array('data' => 'Usulan pergeseran anggaran saudara akan ditampung pada Peraturan Daerah tentang Perubahan Anggaran Pendapatan dan Belanja Daerah Tahun Anggaran ' . apbd_tahun() . '.', 'colspan'=>'3', 'width' => '515px', 'style' => 'text-align:left;'),
						);
		...
		case '2':		//ADM
			...
			$isian = 'Permohonan Saudara untuk melaksanakan Perubahan/ralat karena kesalahan administrasi untuk Ralat/Kesalahan ' . $ralat . ' Kegiatan ' . $kegiatan . '  kami tolak karena tidak sesuai dengan Pasal 4 Peraturan Bupati Jepara Nomor 6 Tahun 2014 Tentang Tata Cara Revisi Anggaran('.$jawaban.')';
			$rows[] = array (
						array('data' => '1.',  'width'=> '20px', 'style' => 'text-align:left;'),
						array('data' => $isian, 'colspan'=>'4', 'width' => '515px', 'style' => 'text-align:left;'),
						);
		...
		case '3':		//DAK
			...
			$isian = 'Permohonan Saudara untuk melaksanakan Penambahan, pengurangan dan/atau pagu angggaran tetap yang dananya bersumber dari transfer Pemerintah Provinsi dan/atau Pemerintah kegiatan ' . $kegiatan . '  kami tolak karena tidak sesuai dengan Pasal 4 Peraturan Bupati Jepara Nomor 6 Tahun 2014 Tentang Tata Cara Revisi Anggaran('.$jawaban.')';
			$rows[] = array (
						array('data' => '1.',  'width'=> '20px', 'style' => 'text-align:left;'),
						array('data' => $isian, 'colspan'=>'3', 'width' => '515px', 'style' => 'text-align:left;'),
						);
