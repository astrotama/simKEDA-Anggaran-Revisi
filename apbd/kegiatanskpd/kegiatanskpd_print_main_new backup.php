...
function GenReportFormSampulBelanja($kodekeg) {
	...
	$rows[] = array (array ('data'=>'DOKUMEN PELAKSANAAN ANGGARAN', 'width'=>'875px', 'colspan'=>'5', 'style' =>'border:none; font-weight:900; font-size:1.75em; text-align:center;'));	
...
function GenReportFormSampulPendapatan($kodeuk) {
...
function GenReportFormSampulDepan($kodeuk) {
	...
	$rows[]= array (
				array('data' => 'DPA - SKPD',  'width'=> '190px', 'style' => 'border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;  font-weight:900; font-size:1em; text-align:left;'),
	...
	$rows[]= array (
				array('data' => 'DPA - SKPD 1',  'width'=> '190px', 'style' => 'border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;  font-weight:900; font-size:1em; text-align:left;'),
	...
	$rows[]= array (
				array('data' => 'DPA - SKPD 2.1',  'width'=> '190px', 'style' => 'border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;  font-weight:900; font-size:1em; text-align:left;'),
	...
	$rows[]= array (
				array('data' => 'DPA - SKPD 2.2',  'width'=> '190px', 'style' => 'border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;  font-weight:900; font-size:1em; text-align:left;'),
	...
	$rows[]= array (
				array('data' => 'DPA - SKPD 2.2.1',  'width'=> '190px', 'style' => 'border-left: 1px solid black; border-right: 1px solid black; border-bottom: 2px solid black;  font-weight:900; font-size:1em; text-align:left;'),
