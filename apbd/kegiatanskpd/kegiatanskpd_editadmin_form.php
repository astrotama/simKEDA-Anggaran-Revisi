...
function kegiatanskpd_editadmin_form_submit($form, &$form_state) {
    if($form_state['clicked_button']['#value'] == $form_state['values']['submitnext']) {
		...
		{					
			...
			$sql = sprintf("insert into {kegiatanskpd} (kodekeg, nomorkeg, tahun, kodepro, kodeuk, kegiatan, jenis, plafon, sumberdana1, sumberdana1rp, 
			...
			$sql = sprintf("update {kegiatanskpd} set kegiatan='%s', plafon='%s', sumberdana1='%s', sumberdana1rp='%s', sumberdana2='%s', 
