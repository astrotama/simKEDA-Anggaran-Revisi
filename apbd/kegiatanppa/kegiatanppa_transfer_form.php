...
function kegiatanppa_transfer($arg=NULL) {
	...
	//if (isSuperuser())
	$filterform = drupal_get_form('kegiatanppa_transfer_filter_form');
		
	$output = "<div id='dv_transferform'>" .$filterform . "</div>". "<div id='dv_transferdata'>" . $output . "</div>";
    return $output;
}
function kegiatanppa_transfer_filter_form() {
	$form['formdata'] = array (
		'#type' => 'fieldset',
	...
	$form['formdata']['filterdata'] = array(
		...
		'#title' => t('Filter Data'), 
		'#default_value' => 0, 
		'#options' => array(t('Data RKPD yang belum ditransfer'), t('Semua Data (Retransfer)')),
		'#weight' => 3,
	);	
