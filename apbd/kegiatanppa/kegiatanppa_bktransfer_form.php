...
function kegiatanppa_bktransfer($arg=NULL) {
	...
	//if (isSuperuser())
	$filterform = drupal_get_form('kegiatanppa_bktransfer_filter_form');
		
	$output = "<div id='dv_bktransferform'>" .$filterform . "</div>". "<div id='dv_transferdata'>" . $output . "</div>";
    return $output;
}
function kegiatanppa_bktransfer_filter_form() {
	$form['formdata'] = array (
		'#type' => 'fieldset',
	...
	$form['formdata']['filterdata'] = array(
		...
		'#title' => t('Filter Data'), 
		'#default_value' => 1, 
		'#options' => array(t('Data PPAS Non RKPD '), t('Semua Data (Duplikasi)')),
		'#weight' => 3,
	);	
