...
function perdabup_form_submit($form, &$form_state) {
	...
	if($form_state['clicked_button']['#value'] == $form_state['values']['tampilkan']) 
        $uri = 'apbd/laporan/apbd/perdabup/' . $kodeuk . '/' . $topmargin . '/' . $hal1 . '/' . $perdabup  . '/' . $lampiran . '/' . $judul . '/' . $ttd;
	else	
		$uri = 'apbd/laporan/apbd/perdabup/' . $kodeuk . '/' . $topmargin . '/' . $hal1 . '/' . $perdabup  . '/' . $lampiran . '/' . $judul . '/' . $ttd . '/pdf' ;
