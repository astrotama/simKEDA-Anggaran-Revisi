...
function laporan_main($arg=NULL) {
	...
	*/
	...
	if (isSuperuser()) {
		...
		$rows[] = array (array('data' => '/apbd/laporan/rka/ringkasananggaran/' . $kodeuk),
						array('data' => 'Ringkasan APBD'),);
		$rows[] = array (array('data' => '/apbd/laporan/rka/rekapaggpad/' . $kodeuk),
						array('data' => 'Rekapitulasi Anggaran Pendapatan'),);
		$rows[] = array (array('data' => '/apbd/laporan/rka/rekapaggbelanja/' . $kodeuk),
						array('data' => 'Rekapitulasi Anggaran Belanja'),);
		$rows[] = array (array('data' => '/apbd/laporan/rka/rekapaggbl/' . $kodeuk  . '/51'),
						array('data' => 'Rekapitulasi Anggaran Belanja Tidak Langsung'),);
		$rows[] = array (array('data' => '/apbd/laporan/rka/rekapaggbl/' . $kodeuk . '/52'),
						array('data' => 'Rekapitulasi Anggaran Belanja Langsung'),);
		$rows[] = array (array('data' => '/apbd/laporan/rka/rekapaggblprogram/' . $kodeuk),
						array('data' => 'Rekapitulasi Anggaran Belanja Langsung per Program/Kegiatan'),);
		$rows[] = array (array('data' => '/apbd/laporan/rka/rekapaggblprogramtw/' . $kodeuk),
