...
function GenReportFormHeader($kodeuk, $tipedok) {
	...
	if ($tipedok=='dpa') {
		$rowskegiatan[]= array ( 
						 ...
						 array('data' => 'RINGKASAN DOKUMEN PELAKSANAAN ANGGARAN', 'width' => '350px','colspan'=>'4', 'style' => 'border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'DPA-SKPD', 'width' => '175',  'style' => 'border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 );
		$rowskegiatan[]= array ( 
						 ...
						 array('data' => 'SATUAN KERJA PERANGKAT DAERAH', 'width' => '350px', 'colspan'=>'4','style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
		...
		$rowskegiatan[]= array ( 
						 ...
						 array('data' => 'RENCANA KERJA DAN ANGGARAN SATUAN KERJA PERANGKAT DAERAH', 'width' => '350px','colspan'=>'4', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	$rowskegiatan[]= array (
					 array('data' => 'Urusan Pemerintahan',  'width'=> '300px', 'style' => 'border-left: 1px solid black; text-align:left;'),
					 array('data' => ':', 'width' => '15px', 'style' => 'text-align:right;'),
					 array('data' => $urusan, 'width' => '560',  'colspan'=>'4', 'style' => 'border-right: 1px solid black; text-align:left;'),
					 );
	$rowskegiatan[]= array (
					 array('data' => 'Organisasi',  'width'=> '300px', 'style' => 'border-left: 1px solid black; text-align:left;'),
					 array('data' => ':',  'width' => '15px', 'style' => 'text-align:right;'),
					 array('data' => $skpd,  'width' => '560', 'colspan'=>'4', 'style' => 'border-right: 1px solid black; text-align:left;'),					 
					);
	$rowskegiatan[]= array (
					 array('data' => 'RINGKASAN ANGGARAN PENDAPATAN DAN BELANJA SKPD',  'width'=> '875px', 'colspan'=>'6', 'style' => 'border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
					 );	
