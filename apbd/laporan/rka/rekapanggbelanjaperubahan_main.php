<?php
function rekapanggbelanjaperubahan_main() {
...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		$pdfFile = 'rka-skpd-rekapanggbelanjaperubahan-' . $kodeuk . '.pdf';
		...
		$url = 'apbd/laporan/rka/rekapanggbelanjaperubahan/'. $kodeuk . '/' . $topmargin . "/pdf";
		$output = drupal_get_form('rekapanggbelanjaperubahan_form');
...
function rekapanggbelanjaperubahan_form () {
	$form['formdata'] = array (
		'#type' => 'fieldset',
...
function rekapanggbelanjaperubahan_form_submit($form, &$form_state) {
	//$kodeuk = $form_state['values']['kodeuk'];
	$kodeuk = $form_state['values']['kodeuk'];
	$topmargin = $form_state['values']['topmargin'];
	
	if($form_state['clicked_button']['#value'] == $form_state['values']['tampilkan'])
		$uri = 'apbd/laporan/rka/rekapanggbelanjaperubahan/' . $kodeuk . '/'. $topmargin . '/' ;
	else
		$uri = 'apbd/laporan/rka/rekapanggbelanjaperubahan/' . $kodeuk . '/'. $topmargin . '/pdf' ;
	drupal_goto($uri);
