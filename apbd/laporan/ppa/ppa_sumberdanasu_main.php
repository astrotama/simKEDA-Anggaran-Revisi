...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		//PDF
		$urlpdf = 'apbd/laporan/ppa_sumberdanasu/' . $kodeuk . '/' . $tahun . '/pdf';
		$urlxls = 'apbd/laporan/ppa_sumberdanasu/' . $kodeuk . '/' . $tahun . '/xls';
...
function ppa_sumberdanasu_form_submit($form, &$form_state) {
	...
	$kodeuk = $form_state['values']['kodeuk'];
	$uri = 'apbd/laporan/ppa_sumberdanasu/' . $kodeuk . '/' . $tahun;
	drupal_goto($uri);
