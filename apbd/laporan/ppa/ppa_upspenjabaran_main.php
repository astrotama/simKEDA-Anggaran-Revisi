...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		//PDF
		$urlpdf = 'apbd/laporan/ppa_upspenjabaran/' . $kodeu . '/' . $tahun . '/pdf';
		$urlxls = 'apbd/laporan/ppa_upspenjabaran/' . $kodeu . '/' . $tahun . '/xls';
...
function ppa_upspenjabaran_form_submit($form, &$form_state) {
	...
	$uri = 'apbd/laporan/ppa_upspenjabaran/' . $kodeu . '/' . $tahun;
	drupal_goto($uri);
