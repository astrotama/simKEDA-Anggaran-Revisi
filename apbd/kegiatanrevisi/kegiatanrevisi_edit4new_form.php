<?php
function kegiatanrevisi_edit4new_form() {
...
function kegiatanrevisi_edit4new_form_validate($form, &$form_state) {
}
 
function kegiatanrevisi_edit4new_form_submit($form, &$form_state) {
