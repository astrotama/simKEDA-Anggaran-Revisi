...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		$url = 'apbd/laporan/rka/rekapaggbelanja/'. $kodeuk . '/' . $topmargin . "/pdf";
...
function rekapaggbelanja_form_submit($form, &$form_state) {
	...
	if($form_state['clicked_button']['#value'] == $form_state['values']['tampilkan'])
		$uri = 'apbd/laporan/rka/rekapaggbelanja/' . $kodeuk . '/'. $topmargin . '/' ;
	else
		$uri = 'apbd/laporan/rka/rekapaggbelanja/' . $kodeuk . '/'. $topmargin . '/pdf' ;
	drupal_goto($uri);
