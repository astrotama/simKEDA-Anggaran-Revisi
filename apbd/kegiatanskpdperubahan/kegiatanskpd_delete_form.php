...
function kegiatanskpd_delete_form() {
...
function kegiatanskpd_delete_form_validate($form, &$form_state) {
}
function kegiatanskpd_delete_form_submit($form, &$form_state) {
