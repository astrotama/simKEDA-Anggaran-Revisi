...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		//PDF
		$urlpdf = 'apbd/laporanpenetapan/musrenbangcamv3/' . $kodeuk . '/' . $tahun . '/pdf';
		$urlxls = 'apbd/laporanpenetapan/musrenbangcamv3/' . $kodeuk . '/' . $tahun . '/xls';
...
function musrenbangcamv3_form_submit($form, &$form_state) {
	...
	$kodeuk = $form_state['values']['kodeuk'];
	$uri = 'apbd/laporanpenetapan/musrenbangcamv3/' . $kodeuk . '/' . $tahun;
	drupal_goto($uri);
