<?php
    function musrenbangcamv2_main() {
        ...
        $exportpdf = arg(6);
        if (!isset($tahun)) 
            return drupal_get_form('musrenbangcamv2_form');
        ...
        if (isset($exportpdf) && ($exportpdf=='pdf'))  {
            ...
            $pdfFile = 'musrenbangcamv2_form.pdf';
            apbd_ExportPDF('L', 'F4', $htmlContent, $pdfFile);
            
        } else {
            $url = 'apbd/laporanpenetapan/musrenbangcamv2/'. $kodeuk .'/'. $tahun . "/0/pdf";
            $output .= drupal_get_form('musrenbangcamv2_form');
            ...
            while ($data = db_fetch_object($result)) {                
                ...
                if ($first) {
                    ...
                    if ($r_kodepro != $kodepro) {
                        //echo 't1';
                        $temp = array (
                            array('data' => $kodepro, 'width' => $col1, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; font-weight:bold;font-size: 100%;'),                            
                            array('data' => $namapro, 'width' => $col2, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:bold;font-size: 100%;'),
                            array('data' => $data->pro_sasaran , 'width' => $colstarget, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:bold;font-size: 100%;'),
                            array('data' => $data->pro_target, 'width' => $colstarget, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid  black; border-right: 1px solid black; font-weight:bold;font-size: 100%;'),
                            array('data' => apbd_fn($jppegawai), 'width' => $colnompegawai, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:bold;font-size: 100%;'),
                            array('data' => apbd_fn($jpbarangjasa), 'width' => $colnombarangjasa, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:bold;font-size: 100%;'),
                            array('data' => apbd_fn($jpmodal), 'width' => $colnommodal, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:bold;font-size: 100%;'),
                ...
                $temp_data[] = array (
                    ...
                    array('data' => $data->kegiatan , 'width' => $col2, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 100%;'),
                    array('data' => $data->sasaran, 'width' => $colstarget, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 100%;'),
                    array('data' => $data->target, 'width' => $colstarget, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 100%;'),
                    array('data' => apbd_fn($data->nompegawai), 'width' => $colnompegawai, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 100%;'),
                    array('data' => apbd_fn($data->nombarangjasa), 'width' => $colnombarangjasa, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 100%;'),
                    array('data' => apbd_fn($data->nommodal), 'width' => $colnommodal, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 100%;'),
        ...
        if ($kodeuk!='00') {
                if ($print==0) {
                    ...
                    $rows[] = array (
                        ...
                        array('data' => '', 'width' => '150px'),
                        array('data' => '', 'width' => '150px'),
                        array('data' => $pimpinannama , 'width' => '360px', 'colspan'=>'4', 'height'=>'50px', 'style'=>'text-align:center'),
                    );
                    $rows[] = array (
                        array('data' => '', 'width' => '50px'),                    
                        array('data' => '', 'width' => '190px'),
                        array('data' => '', 'width' => '150px'),
                        array('data' => '', 'width' => '150px'),
                        array('data' => $pimpinannip , 'width' => '360px', 'colspan'=>'4', 'height'=>'50px', 'style'=>'text-align:center'),
                    );
    ...
    function musrenbangcamv2_form_submit($form, &$form_state) {
        //$kodeuk = $form_state['values']['kodeuk'];
        $tahun = $form_state['values']['tahun'];
        $record = $form_state['values']['record'];
        $kodeuk = $form_state['values']['kodeuk'];
        $uri = 'apbd/laporanpenetapan/musrenbangcamv2/' .$kodeuk . '/' . $tahun . '/' . $record;
        drupal_goto($uri);
