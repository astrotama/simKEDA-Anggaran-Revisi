<?php
    ...
    drupal_add_css('files/css/kegiatancam.css');
        ...
        if (isset($exportpdf) && ($exportpdf=='pdf'))  {
            ...
            $url = 'apbd/laporanpenetapan/rkpdv2/'. $kodeuk .'/'. $status . '/'. $tahun . "/0/pdf";
    ...
    function GenReportForm($print=0) {
        ...
        $sql = 'select d.namasingkat, d.kodedinas, p.kodeu, u.urusansingkat, p.program, p.np, k.kodekeg, k.nomorkeg, k.tahun, k.kodepro, k.kodeuk, k.kodeuktujuan, k.kegiatan, k.lokasi, k.sasaran, k.target, k.total, k.totalsebelum, k.totalsebelum2, k.totalpenetapan, k.apbdkab, k.pnpm, d.namasingkat from {kegiatanrkpd} k left join unitkerja d on(k.kodeuk=d.kodeuk) left join program p on (k.kodepro = p.kodepro) left join urusan u on (d.kodeu = u.kodeu)' . $where;
        ...
        $rows= array();
        $headers[] = array (array ('data'=>'RENCANA KERJA PEMERINTAH DAERAH (RKPD) ', 'width'=>'900px', 'colspan'=>'8', 'style' =>'border: 0px solid white;font-weight:900;font-size:1.3em;text-align:center;'));
        ...
        $headers[] = array (
                             array('data' => 'KODE PROGRAM KEGIATAN',  'rowspan'=>'2', 'width'=> '99px', 'style' => 'border: 1px solid black; text-align:center;'),
                             ...
                             array('data' => 'SASARAN TARGET / VOLUME',  'rowspan'=>'2', 'width' => '95px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
        ...
        if ($result) {
            ...
            while ($data = db_fetch_object($result)) {                
                ...
                if ($first) {
                    ...
                    if ($r_program != $program) {
                        $temp = array (
                            ...
                            array('data' => $program_deskripsi , 'colspan'=>'3', 'width' => '360px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                    ...
                    if ($r_dinas != $dinas) {
                        $temp = array (
                            ...
                            array('data' => $dinas_deskripsi , 'colspan'=>'3', 'width' => '360px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                            //array('data' => '' , 'width' => '95px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                            //array('data' => '', 'width' => '95px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                    ...
                    if ($urusan != $r_urusan) {
                        ...
                        $temp = array (
                            ...
                            array('data' => $urusan_deskripsi , 'colspan'=>'3', 'width' => '360px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                            //array('data' => '' , 'width' => '95px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                            //array('data' => '', 'width' => '95px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                    ...
                    if ($sifat != $r_sifat) {
                        ...
                        $temp = array (
                            ...
                            array('data' => $tnama , 'colspan'=>'3', 'width' => '360px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
                ...
                $temp_data[] = array (
                    ...
                    array('data' => $indikator, 'width' => '95px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;'),
            ...
            if (count($temp_data)>0) {
                ...
                $temp = array (
                    array('data' => $sifat, 'width' => '99px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; font-size: 1em;font-weight:900;'),                            
                    array('data' => $tnama , 'colspan'=>'3', 'width' => '360px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
            ...
            if (count($rows) > 0) {
                ...
                $temp = array (
                    ...
                    array('data' => 'JUMLAH URUSAN WAJIB DAN PILIHAN' , 'colspan'=>'3', 'width' => '360px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
                    //array('data' => '', 'width' => '95px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
                    //array('data' => '', 'width' => '95px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
    ...
    function rkpd_form_submit($form, &$form_state) {
        ...
        $uri = 'apbd/laporanpenetapan/rkpdv2/' .$kodeuk .'/'. $status . '/' . $tahun . '/' . $record;
        drupal_goto($uri);
