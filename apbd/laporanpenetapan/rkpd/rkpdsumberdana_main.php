...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		//PDF
		$urlpdf = 'apbd/laporanpenetapan/rkpdsumberdana/' . $kodeuk . '/' . $tahun . '/pdf';
		$urlxls = 'apbd/laporanpenetapan/rkpdsumberdana/' . $kodeuk . '/' . $tahun . '/xls';
...
function rkpdsumberdana_form_submit($form, &$form_state) {
	...
	$kodeuk = $form_state['values']['kodeuk'];
	$uri = 'apbd/laporanpenetapan/rkpdsumberdana/' . $kodeuk . '/' . $tahun;
	drupal_goto($uri);
