...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		$url = 'apbd/laporanpenetapan/apbd/lampiran1/'. $kodeuk . '/' . $topmargin . '/' . $hal1 . '/pdf';
...
function lampiran1_form_submit($form, &$form_state) {
	...
	if($form_state['clicked_button']['#value'] == $form_state['values']['tampilkan']) 
        $uri = 'apbd/laporanpenetapan/apbd/lampiran1/' . $kodeuk . '/' . $tingkat . '/'. $topmargin . '/' . $hal1;
	else	
		$uri = 'apbd/laporanpenetapan/apbd/lampiran1/' . $kodeuk . '/' . $tingkat . '/'. $topmargin . '/' . $hal1 . '/pdf' ;
