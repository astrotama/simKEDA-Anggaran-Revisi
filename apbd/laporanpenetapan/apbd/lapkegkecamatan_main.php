...
function lapkegkecamatan_form_submit($form, &$form_state) {
	...
	if($form_state['clicked_button']['#value'] == $form_state['values']['tampilkan']) 
        $uri = 'apbd/laporanpenetapan/apbd/lapkegkecamatan/' . $kodeuk . '/' . $topmargin . '/' . $hal1 ;
	else	
		$uri = 'apbd/laporanpenetapan/apbd/lapkegkecamatan/' . $kodeuk . '/' . $topmargin . '/' . $hal1 . '/pdf' ;
