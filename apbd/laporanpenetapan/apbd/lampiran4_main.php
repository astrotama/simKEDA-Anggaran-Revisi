...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		$url = 'apbd/laporanpenetapan/apbd/lampiran4/'. $topmargin . "/pdf";
...
function lampiran4_form_submit($form, &$form_state) {
	...
	if($form_state['clicked_button']['#value'] == $form_state['values']['tampilkan']) 
		$uri = 'apbd/laporanpenetapan/apbd/lampiran4/' . $topmargin . '/' . $hal1 ;
	else
		$uri = 'apbd/laporanpenetapan/apbd/lampiran4/' . $topmargin . '/' . $hal1 . '/pdf' ;
	drupal_goto($uri);
