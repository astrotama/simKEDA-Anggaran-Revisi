...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		$url = 'apbd/laporanpenetapan/rka/ringkasananggaran/'. $kodeuk . '/' . $topmargin . "/pdf";
...
function ringkasananggaran_form_submit($form, &$form_state) {
	...
	if($form_state['clicked_button']['#value'] == $form_state['values']['tampilkan']) 
        $uri = 'apbd/laporanpenetapan/rka/ringkasananggaran/' . $kodeuk . '/' . $tingkat . '/'. $topmargin . '/' . $tipedok . '/' ;
	else	
		$uri = 'apbd/laporanpenetapan/rka/ringkasananggaran/' . $kodeuk . '/' . $tingkat . '/'. $topmargin . '/' . $tipedok . '/pdf' ;
