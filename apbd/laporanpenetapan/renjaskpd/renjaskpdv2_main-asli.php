<?php
	// Versi revisi 1
	// Format pembahasan Renja SKPD yg sudah masuk hasil Musrenbangcam
	// Usulan kecamatan ===> total
	// Usulan SKPD		===> totalpetenapatan
    ...
    drupal_add_css('files/css/kegiatancam.css');
        ...
        if (isset($exportpdf) && ($exportpdf=='pdf'))  {
            ...
            $url = 'apbd/laporanpenetapan/renjaskpdv2/'. $kodeuk .'/'. $status . '/'. $tahun . "/0/pdf";
        ...
        if ($result) {
            ...
            while ($data = db_fetch_object($result)) {                
                ...
                if ($first) {
                    ...
                    //        array('data' => $tnama, 'width' => '170px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
...
/*                $tnama = $sifat_urusan_array[$sifat];
                $temp = array (
                    array('data' => $sifat, 'width' => '99px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; font-size: 1em;font-weight:900;'),                            
                    array('data' => $tnama , 'width' => '170px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
                ...
                $sifat_data= array_merge($sifat_data, $urusan_data);
 */           }
            $rows = array_merge($rows, $urusan_data);
    ...
    function renjaskpd_form_submit($form, &$form_state) {
        ...
        $uri = 'apbd/laporanpenetapan/renjaskpdv2/' .$kodeuk .'/'. $status . '/' . $tahun . '/' . $record;
        drupal_goto($uri);
