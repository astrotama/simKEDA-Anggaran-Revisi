<?php
    ...
    drupal_add_css('files/css/kegiatancam.css');
        ...
        if (isset($exportpdf) && ($exportpdf=='pdf'))  {
            ...
            $url = 'apbd/laporanpenetapan/renjaskpdbidang/' . $kodebid . '/' . $kodeuk . '/'. $tahun . "/0/" . $status . "/pdf";
    ...
    function renjaskpdbidang_form_submit($form, &$form_state) {
        ...
        $uri = 'apbd/laporanpenetapan/renjaskpdbidang/' . $kodebid . '/' . $kodeuk . '/' . $tahun . '/' . $record . '/' . $status;
