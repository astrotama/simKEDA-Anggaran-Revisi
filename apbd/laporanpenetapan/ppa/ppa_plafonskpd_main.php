<?php
    function ppa_plafonskpd_main() {
        ...
        $exportpdf = arg(6);
        if (!isset($tahun)) 
            return drupal_get_form('ppa_plafonskpd_form');
        ...
        if (isset($exportpdf) && ($exportpdf=='pdf'))  {
            ...
            $pdfFile = 'ppa_plafonskpd_form.pdf';
            apbd_ExportPDF('P', 'F4', $htmlContent, $pdfFile);
            
        } else {
            $url = 'apbd/laporanpenetapan/ppaplafonskpd/'. $kodeuk .'/'. $tahun . "/0/pdf";
            $output .= drupal_get_form('ppa_plafonskpd_form');
    ...
    function GenReportForm($print=0) {
        ...
        $col1 = '50px';
        $col2 = '175px';		//'175px';
        $colstarget = '105px';	//'125px';	//'125px';
        $colplafon = '90px';
        
        $coltotal = '440px';	//'475px';
        ...
        if ($kodeuk!='00') {
                if ($print==0) {
                    ...
                    $rows[] = array (
                        ...
                        array('data' => '', 'width' => '175px'),
                        array('data' => '', 'width' => '125px'),
                        array('data' => $pimpinanjabatan , 'width' => '250px', 'colspan'=>'2', 'height'=>'50px', 'style'=>'text-align:center'),
                    );
                    $rows[] = array (
                        array('data' => '', 'width' => '50px'),                    
                        array('data' => '', 'width' => '175px'),
                        array('data' => '', 'width' => '125px'),
                        array('data' => $pimpinannama , 'width' => '250px', 'colspan'=>'2', 'height'=>'50px', 'style'=>'text-align:center'),
                    );
                    $rows[] = array (
                        array('data' => '', 'width' => '50px'),                    
                        array('data' => '', 'width' => '175px'),
                        array('data' => '', 'width' => '125px'),
                        array('data' => $pimpinannip , 'width' => '250px', 'colspan'=>'2', 'height'=>'50px', 'style'=>'text-align:center'),
                    );
    ...
    function ppa_plafonskpd_form_submit($form, &$form_state) {
        //$kodeuk = $form_state['values']['kodeuk'];
        $tahun = $form_state['values']['tahun'];
        $record = $form_state['values']['record'];
        $kodeuk = $form_state['values']['kodeuk'];
        $uri = 'apbd/laporanpenetapan/ppaplafonskpd/' .$kodeuk . '/' . $tahun . '/' . $record;
        drupal_goto($uri);
