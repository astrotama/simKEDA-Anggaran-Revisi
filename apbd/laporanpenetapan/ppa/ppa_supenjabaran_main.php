...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		//PDF
		$urlpdf = 'apbd/laporanpenetapan/ppa_supenjabaran/' . $kodeuk . '/' . $tahun . '/pdf';
		$urlxls = 'apbd/laporanpenetapan/ppa_supenjabaran/' . $kodeuk . '/' . $tahun . '/xls';
...
function ppa_supenjabaran_form_submit($form, &$form_state) {
	...
	$kodeuk = $form_state['values']['kodeuk'];
	$uri = 'apbd/laporanpenetapan/ppa_supenjabaran/' . $kodeuk . '/' . $tahun;
	drupal_goto($uri);
