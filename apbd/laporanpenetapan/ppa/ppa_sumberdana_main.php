...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		//PDF
		$urlpdf = 'apbd/laporanpenetapan/ppa_sumberdana/' . $kodeu . '/' . $tahun . '/pdf';
		$urlxls = 'apbd/laporanpenetapan/ppa_sumberdana/' . $kodeu . '/' . $tahun . '/xls';
...
function ppa_sumberdana_form_submit($form, &$form_state) {
	...
	$uri = 'apbd/laporanpenetapan/ppa_sumberdana/' . $kodeu . '/' . $tahun;
	drupal_goto($uri);
