<?php
    ...
    drupal_add_css('files/css/kegiatancam.css');
        ...
        if (isset($exportpdf) && ($exportpdf=='pdf'))  {
            ...
            $url = 'apbd/laporanpenetapan/ppas/'. $kodeuk .'/'. $status . '/'. $tahun . "/0/pdf";
    ...
    function GenReportForm($print=0) {
        ...
        $rows= array();
        $headers[] = array (array ('data'=>'RANCANGAN PRIORITAS DAN PLAFON ANGGARAN SEMENTARA (PPAS)', 'width'=>'900px', 'colspan'=>'8', 'style' =>'border: 0px solid white;font-weight:900;font-size:1.3em;text-align:center;'));
        ...
        $headers[] = array (
                             array('data' => 'KODE',  'rowspan'=>'1', 'width'=> '99px', 'style' => 'border: 1px solid black; text-align:center;'),
                             array('data' => 'PRIORITAS PROGRAM & KEGIATAN',  'rowspan'=>'1', 'width' => '380px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
                             array('data' => 'SASARAN, TARGET, VOLUME',  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
                             array('data' => 'SKPD' ,  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
                             array('data' => 'JUMLAH PLAFON ANGGARAN (Rp)', 'rowspan'=>'1','colspan'=>'1',  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
                             );
        //$headers[] = array (
        ...
        if ($result) {
            ...
            while ($data = db_fetch_object($result)) {                
                ...
                if ($first) {
                    ...
                    if ($r_program != $program) {
                        $temp = array (
                            ...
                            array('data' => $program_deskripsi , 'colspan'=>'1', 'width' => '380px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                             array('data' => '',  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                             array('data' => '' ,  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    ...
                    //        array('data' => $dinas_deskripsi , 'colspan'=>'1', 'width' => '380px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                    //         array('data' => '',  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    //         array('data' => '' ,  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    //         array('data' => '',  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    //         array('data' => '' ,  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    ...
                    if ($urusan != $r_urusan ) {
                        ...
                        $temp = array (
                            ...
                            array('data' => $urusan_deskripsi , 'colspan'=>'1', 'width' => '380px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                            array('data' => '',  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                            array('data' => '',  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    ...
                    if ($sifat != $r_sifat) {
                        ...
                        $temp = array (
                            ...
                            array('data' => $tnama , 'colspan'=>'1', 'width' => '380px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
                            array('data' => '',  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                            array('data' => '' ,  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                ...
                $temp_data[] = array (
                    ...
                    array('data' => $data->kegiatan . $nuk, 'width' => '380px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;'),
                    array('data' => $indikator, 'width' => '165px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;'),
                    array('data' => $data->namasingkat, 'width' => '165px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;'),
            ...
            if (count($temp_data)>0) {
                ...
                $temp = array (
                    array('data' => $sifat, 'width' => '99px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; font-size: 1em;font-weight:900;'),                            
                    array('data' => $tnama , 'colspan'=>'1', 'width' => '380px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
                    array('data' => '',  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    array('data' => '' ,  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
            ...
            if (count($rows) > 0) {
                ...
                $temp = array (
                    ...
                    array('data' => 'JUMLAH URUSAN WAJIB DAN PILIHAN' , 'colspan'=>'1', 'width' => '380px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
                    array('data' => '',  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    array('data' => '' ,  'rowspan'=>'1', 'width' => '165px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
    ...
    function ppa_form_submit($form, &$form_state) {
        ...
        $uri = 'apbd/laporanpenetapan/ppas/' .$kodeuk .'/'. $status . '/' . $tahun . '/' . $record;
        drupal_goto($uri);
