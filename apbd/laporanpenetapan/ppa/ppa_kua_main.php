<?php
    ...
    drupal_add_css('files/css/kegiatancam.css');
        ...
        if (isset($exportpdf) && ($exportpdf=='pdf'))  {
            ...
            $url = 'apbd/laporanpenetapan/kua/'. $kodeuk .'/'. $status . '/'. $tahun . "/0/pdf";
    ...
    function GenReportForm($print=0) {
        ...
        $sql = 'select d.namasingkat, d.kodedinas, p.kodeu, u.urusansingkat, p.program, p.np, k.kodekeg, k.nomorkeg, k.tahun, k.kodepro, k.kodeuk, k.kodeuktujuan, k.kegiatan, k.lokasi, k.sasaran, k.target, k.total, k.totalsebelum, k.totalsebelum2, k.totalpenetapan, k.apbdkab, k.pnpm, d.namasingkat from {kegiatanppa} k left join unitkerja d on(k.kodeuk=d.kodeuk) left join program p on (k.kodepro = p.kodepro) left join urusan u on (d.kodeu = u.kodeu)' . $where;
        ...
        $rows= array();
        $headers[] = array (array ('data'=>'KEBIJAKSANAAN UMUM ANGGARAN ( KUA ) PENDAPATAN DAN BELANJA DAERAH ', 'width'=>'900px', 'colspan'=>'8', 'style' =>'border: 0px solid white;font-weight:900;font-size:1.3em;text-align:center;'));
        $headers[] = array (array ('data'=> $namauk . "&nbsp;" . $kabupaten , 'width'=>'900px', 'colspan'=>'8', 'style' =>'border: 0px solid white;font-weight:900;font-size:1.3em;text-align:center;'));
        $headers[] = array (array ('data'=> 'TAHUN ' . $tahun, 'width'=>'900px', 'colspan'=>'8', 'style' =>'border: 0px solid white;font-weight:900;font-size:1.3em;text-align:center;'));
        ...
        $headers[] = array (
                             array('data' => 'KODE REKENING',  'rowspan'=>'1', 'width'=> '99px', 'style' => 'border: 1px solid black; text-align:center;'),
                             array('data' => 'URUSAN, PROGRAM & KEGIATAN',  'rowspan'=>'1', 'width' => '270px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
                             array('data' => 'SASARAN',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
                             array('data' => 'LOKASI' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
                             array('data' => 'TARGET',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
                             array('data' => 'ORGANISASI' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
                             array('data' => 'PAGU ANGGARAN (Rp)', 'rowspan'=>'1','colspan'=>'1',  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:center;'),
                             );
        //$headers[] = array (
        ...
        //                     array('data' => '6',  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
        //                     array('data' => '7 ',  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
        //                     array('data' => '8',  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
        ...
        if ($result) {
            ...
            while ($data = db_fetch_object($result)) {                
                ...
                if ($first) {
                    ...
                    if ($r_program != $program) {
                        $temp = array (
                            ...
                            array('data' => $program_deskripsi , 'colspan'=>'1', 'width' => '270px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                             array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                             array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                             array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                             array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                            array('data' => apbd_fn($japbdkab_program), 'width' => '90px', 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                        );
                    ...
                    //        array('data' => $dinas_deskripsi , 'colspan'=>'1', 'width' => '270px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                    //         array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    //         array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    //         array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    //         array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    //        array('data' => apbd_fn($japbdkab_dinas), 'width' => '90px', 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                    //    );
                    ...
                    if ($urusan != $r_urusan) {
                        ...
                        $temp = array (
                            ...
                            array('data' => $urusan_deskripsi , 'colspan'=>'1', 'width' => '270px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                             array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                             array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                             array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                             array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                            array('data' => apbd_fn($japbdkab_urusan), 'width' => '90px', 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
                        );
                        array_unshift($program_data, $temp);
                        $urusan_data=array_merge($urusan_data, $program_data); 
                        $program_data=array();
                    ...
                    if ($sifat != $r_sifat) {
                        ...
                        $temp = array (
                            ...
                            array('data' => $tnama , 'colspan'=>'1', 'width' => '270px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
                             array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                             array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                             array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                             array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                            array('data' => apbd_fn($japbdkab_sifat), 'width' => '90px', 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
                        );
                ...
                $temp_data[] = array (
                    ...
                    array('data' => $data->kegiatan . $nuk, 'width' => '270px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;'),
                    ...
                    array('data' => '', 'width' => '110px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;'),
                    array('data' => apbd_fn($apbdkab), 'width' => '90px', 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size: 1em;'),
                );
            ...
            if (count($temp_data)>0) {
                ...
                $temp = array (
                    array('data' => $sifat, 'width' => '99px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; font-size: 1em;font-weight:900;'),                            
                    array('data' => $tnama , 'colspan'=>'1', 'width' => '270px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
                    array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    array('data' => apbd_fn($japbdkab_sifat), 'width' => '90px', 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
                );
                array_unshift($urusan_data, $temp);
                $sifat_data= array_merge($sifat_data, $urusan_data);
            }
            ...
            if (count($rows) > 0) {
                //total
                $temp = array (
                    array('data' => '', 'width' => '99px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; font-size: 1em;font-weight:900;'),                            
                    array('data' => 'JUMLAH URUSAN WAJIB DAN PILIHAN' , 'colspan'=>'1', 'width' => '270px', 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
                    array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    array('data' => '',  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    array('data' => '' ,  'rowspan'=>'1', 'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; '),
                    array('data' => apbd_fn($total_apbdkab), 'width' => '90px', 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
                );
    ...
    function ppa_form_submit($form, &$form_state) {
        ...
        $uri = 'apbd/laporanpenetapan/kua/' .$kodeuk .'/'. $status . '/' . $tahun . '/' . $record;
        drupal_goto($uri);
