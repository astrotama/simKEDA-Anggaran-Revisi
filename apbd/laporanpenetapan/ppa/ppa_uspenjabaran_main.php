<?php
function ppa_uspenjabaran_main() {
...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (!isset($tahun)) 
		return drupal_get_form('ppa_uspenjabaran_form');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		ppa_uspenjabaran_exportexcel($kodeu, $tahun);
		
	} else {
		//PDF
		$urlpdf = 'apbd/laporanpenetapan/ppa_uspenjabaran/' . $kodeu . '/' . $tahun . '/pdf';
		$urlxls = 'apbd/laporanpenetapan/ppa_uspenjabaran/' . $kodeu . '/' . $tahun . '/xls';
		$output .= drupal_get_form('ppa_uspenjabaran_form');
...
function ppa_uspenjabaran_form () {
	$form['formdata'] = array (
		'#type' => 'fieldset',
...
function ppa_uspenjabaran_form_submit($form, &$form_state) {
	//$kodeu = $form_state['values']['kodeuk'];
	$tahun = $form_state['values']['tahun'];
	$kodeu = $form_state['values']['kodeu'];
	$uri = 'apbd/laporanpenetapan/ppa_uspenjabaran/' . $kodeu . '/' . $tahun;
	drupal_goto($uri);
	

}

function ppa_uspenjabaran_exportexcel($kodeu, $tahun) {
...
$fname = 'penjabaran_ppas_urusan_skpd_' . $tahun . '.xlsx';
