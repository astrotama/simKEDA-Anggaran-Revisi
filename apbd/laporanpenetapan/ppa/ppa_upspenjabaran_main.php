<?php
function ppa_upspenjabaran_main() {
...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (!isset($tahun)) 
		return drupal_get_form('ppa_upspenjabaran_form');

	//if (isUserKecamatan()) {
	//    if ($kodeu != apbd_getuseruk())
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		ppa_upspenjabaran_exportexcel($kodeu, $tahun);
		
	} else {
		//PDF
		$urlpdf = 'apbd/laporanpenetapan/ppa_upspenjabaran/' . $kodeu . '/' . $tahun . '/pdf';
		$urlxls = 'apbd/laporanpenetapan/ppa_upspenjabaran/' . $kodeu . '/' . $tahun . '/xls';
		$output .= drupal_get_form('ppa_upspenjabaran_form');
...
function GenReportForm($print=0) {
	...
	if ($kodeu !='---') {
		...
		/*
		$pquery = sprintf("select kodeuk, namasingkat from {unitkerja} where kodeuk='%s'", db_escape_string($kodeu));
	...
	if ($result) {
		...
		while ($data = db_fetch_object($result)) {                
			...
			if ($first) {
				...
				if ($r_upro != $upro) {
					...
					//PROGRAM
					$temp = array (
						array('data' => $upro, 'width' => $col1, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; border-left: 1px solid black; font-weight:700;font-size: 1em;'),                            
						array('data' => $upro_nama, 'width' => $col2, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
						array('data' => apbd_fn($jang_pegawai) , 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
						array('data' => apbd_fn($jang_barangjasa), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
						array('data' => apbd_fn($jang_modal), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
						array('data' => apbd_fn($jang_total), 'width' => $colplafon, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
					);
					...
					$upro = $r_upro;
					$upro_nama = $data->program;
					if ($kodeu!='---') $u2_nama = $data->urusansingkat;
					$jang_total = (double)$data->jtotal;
					$jang_modal = (double) $data->jmodal;
					$jang_barangjasa = (double) $data->jbarangjasa;
					$jang_pegawai = (double) $data->jpegawai;
				...
				if ($u2 != $r_u2) {
					...
					if ($kodeu!='---') $u2_nama = $data->urusansingkat;
					$temp = array (
						array('data' => $u2, 'width' => $col1, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; border-left: 1px solid black; font-weight:700;font-size: 1em;'),
						array('data' => $u2_nama, 'width' => $col2, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
						array('data' => apbd_fn($ju2_jpegawai) , 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
						array('data' => apbd_fn($ju2_jbarangjasa), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
						array('data' => apbd_fn($ju2_jmodal), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
						array('data' => apbd_fn($ju2), 'width' => $colplafon, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
					);
				...
				if ($u != $r_u) {
					...
					$tnama = $u_array[$u];
					$temp = array (
						array('data' => $u, 'width' => $col1, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; border-left: 1px solid black; font-size: 1em;font-weight:900;'),
						array('data' => $tnama, 'width' => $col2, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
						array('data' => apbd_fn($ju_jpegawai), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
						array('data' => apbd_fn($ju_jbarangjasa), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
						array('data' => apbd_fn($ju_jmodal), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
						array('data' => apbd_fn($ju), 'width' => $colplafon, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
					);
			...
			$temp_data[] = array (
				array('data' => $tkode, 'width' => $col1, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; border-left: 1px solid black; font-size: 1em;'),                    
				array('data' => $data->namasingkat , 'width' => $col2, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;'),
		...
		if (count($temp_data)>0) {
			...
			$temp = array (
				array('data' => $upro, 'width' => $col1, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; border-left: 1px solid black; font-weight:700;font-size: 1em;'),                            
				array('data' => $upro_nama, 'width' => $col2, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
				array('data' => apbd_fn($jang_pegawai) , 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'id' => 'aa', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
				array('data' => apbd_fn($jang_barangjasa), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
				array('data' => apbd_fn($jang_modal), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
				array('data' => apbd_fn($jang_total), 'width' => $colplafon, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:700;font-size: 1em;'),
			);
			...
			$temp = array (
				//TOP URUSAN
				array('data' => $u, 'width' => $col1, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; border-left: 1px solid black; font-size: 1em;font-weight:900;'),                            
				array('data' => $tnama , 'width' => $col2, 'align' => 'left', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
				array('data' => apbd_fn($ju_jpegawai), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
				array('data' => apbd_fn($ju_jbarangjasa), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
				array('data' => apbd_fn($ju_jmodal), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
				array('data' => apbd_fn($ju), 'width' => $colplafon, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
			);
		...
		if (count($rows) > 0) {
			//total
			$rows[] = array (
				array('data' => 'Total', 'colspan'=>'2', 'width' => $coltotal, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; border-left: 1px solid black; font-size: 1em;font-weight:900;'),

				array('data' => apbd_fn($totaljpegawai), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
				array('data' => apbd_fn($totaljbarangjasa), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
				array('data' => apbd_fn($totaljmodal), 'width' => $colrekening, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-size: 1em;font-weight:900;'),
				
				array('data' => apbd_fn($total), 'width' => $colplafon, 'align' => 'right', 'valign'=>'top', 'style' => 'border-bottom: 0.5px solid grey; border-right: 1px solid black; font-weight:900;font-size: 1em;'),
			);
...
function ppa_upspenjabaran_form () {
	$form['formdata'] = array (
		'#type' => 'fieldset',
...
function ppa_upspenjabaran_form_submit($form, &$form_state) {
	//$kodeu = $form_state['values']['kodeuk'];
	$tahun = $form_state['values']['tahun'];
	$kodeu = $form_state['values']['kodeu'];
	$uri = 'apbd/laporanpenetapan/ppa_upspenjabaran/' . $kodeu . '/' . $tahun;
	drupal_goto($uri);
	

}

function ppa_upspenjabaran_exportexcel($kodeu, $tahun) {
...
$fname = 'penjabaran_ppas_urusan_program_skpd_' . $tahun . '.xlsx';
