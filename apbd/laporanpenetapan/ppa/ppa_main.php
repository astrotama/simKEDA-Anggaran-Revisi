<?php
    ...
    drupal_add_css('files/css/kegiatancam.css');
        ...
        if (isset($exportpdf) && ($exportpdf=='pdf'))  {
			...
			//PDF
            $urlpdf = 'apbd/laporanpenetapan/ppa/'. $kodeuk .'/'. $status . '/'. $tahun . "/0/pdf";
            $urlxls = 'apbd/laporanpenetapan/ppa/'. $kodeuk .'/'. $status . '/'. $tahun . "/0/xls";
    ...
    function ppa_form_submit($form, &$form_state) {
        ...
        $uri = 'apbd/laporanpenetapan/ppa/' .$kodeuk .'/'. $status . '/' . $tahun . '/' . $record;
        drupal_goto($uri);
